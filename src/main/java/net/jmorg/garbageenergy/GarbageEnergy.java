...
@Mod(modid = GarbageEnergy.MODID, name = GarbageEnergy.MODNAME, version = GarbageEnergy.VERSION, dependencies = GarbageEnergy.DEPENDENCIES, customProperties = @Mod.CustomProperty(k = "cofhversion", v = "true"))
